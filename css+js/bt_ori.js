...
function getColor(d) {
         return d == 'Kultur & Freizeit' ? "#005080" :
                d == 'Architektur & Denkm&#228ler' ? "#32cccc" :
                d == 'Geschichte' ? "#f0d060" :
...
var legend = L.control({position: 'bottomleft'});
    ...
    categories = ['Kultur & Freizeit','Architektur & Denkm&#228ler','Geschichte','Hotels und Gastst&#228tten','-----------------------','Wanderwege','Pilgerwege','Radwege'];
